...
- Each panel is an extinction event or a milestone. Click a panel to see what disappeared, why, and what came after.
...
It's one HTML file, so there's nothing to install.
